...
对于超出 MEMORY.md 和 USER.md 范围的更深层持久化记忆，Hermes 内置了 9 个外部记忆提供商插件——Honcho、OpenViking、Mem0、Hindsight、Holographic、RetainDB、ByteRover、Supermemory 和 TencentDB Agent Memory。
